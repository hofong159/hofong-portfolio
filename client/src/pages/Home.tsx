...
import { syncSiteContent } from "@/lib/firebase";
      ...
      {page === "home" ? (
        <main>
          ...
          <section className="timeline-section" id="timeline">
            ...
            <div className="timeline"><div className="timeline-line" />{[
            ...
            ].map(([date, title, detail]) => <div className="timeline-item" key={date}><span className="timeline-date">{date}</span><div><h3>{title}</h3><p>{detail}</p></div></div>)}</div>
